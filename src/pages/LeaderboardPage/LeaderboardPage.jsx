                      ...
                      {leader.achievements.includes(1) ? (
                        ...
                        <>
                          <div class={styles.tooltip}>
                            ...
                            <span class={styles.tooltiptext}>Игра пройдена в легком режиме</span>
                          </div>
                        </>
                      )}
                    </span>
                      ...
                      {leader.achievements.includes(2) ? (
                        <>
                          <div class={styles.tooltip}>
                            ...
                            <span class={styles.tooltiptext}>Игра пройдена без супер сил</span>
                          </div>
                        </>
                      ) : (
                        <>
                          <div class={styles.tooltip}>
                            ...
                            <span class={styles.tooltiptext}>Игра пройдена с супер силой</span>
                          </div>
                        </>
                      )}
                    </span>
